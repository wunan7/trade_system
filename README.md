...
## 🏆 回测表现（2023-03-31 ~ 2026-03-31）

| 策略 | 总收益率 | 年化收益 | 最大回撤 | 超额收益 | 适用场景 |
|------|---------|---------|---------|---------|---------|
| **concentrated_v2** | **+28.99%** | +8.85% | -23.11% | +12.26% | 🥇 追求高收益的激进型投资者 |
| **tactical (组合)** | +17.44% | +5.50% | **-15.83%** | +0.71% | 🛡️ 追求极致风控的机构资金 |
| regime_aware | +28.04% | +8.58% | -21.75% | +11.31% | 稳健型单策略 |
| resonance_v2 | +27.02% | +8.29% | -22.33% | +10.29% | 多层级共振优化 |

> 基准：沪深300 同期收益 +16.73%

详细策略对比与分析见：[docs/策略优化探索/01_总结报告.md](docs/策略优化探索/01_总结报告.md)
